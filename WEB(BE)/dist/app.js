...
app.use((0, _expressSession["default"])(sessionConfig)); //passport config
...
_passport["default"].deserializeUser(_user["default"].deserializeUser()); //mongoose connection
