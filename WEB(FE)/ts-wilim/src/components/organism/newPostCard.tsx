    ...
    return (
        <Box width="calc(100% - 2rem)">
            <Flex flexDirection="column" alignItems="flex-start">
                ...
                <Input type="text" width="calc(100% - 2rem)" placeholder="어떤 질문이 하고싶나요? 원하는 질문을 자유롭게 적어주세요!" style={{ color: "white", background: "none", border: "none", boxShadow: "none" }} onChange={(e) => handleChange(e)} name="content" value={newPostForm.content} />
